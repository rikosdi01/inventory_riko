...
import 'package:rikoparts/arsip/isipenerimaan.dart';
        ...
        return GestureDetector(
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => IsiPenerimaanPage(
                  selectedVendor: currentpenerimaan.vendor,
                  selectedTanggal: currentpenerimaan.tanggal,
                  selectedPesanan: currentpenerimaan.pesanan,
                  selectedKode: currentpenerimaan.kode,
                  selectedRak: currentpenerimaan.rak,
                  // selectedItem: currentpenerimaan.item[index],
                  // selectedQty: currentpenerimaan.qty[index],
                  selectedDeskripsi: currentpenerimaan.deskripsi,
                ),
              ),
            );
          },
