              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => ItemInfoPage(
                        selectedImage: currentItem.image,
                        selectedItem: currentItem.item,
                        selectedKode: currentItem.kode,
                        selectedHarga: currentItem.harga,
                        selectedSatuan: currentItem.satuan,
                        selectedIsi: currentItem.isi,
                      ),
                    ),
                  );
                },
                                  ...
                                  child: Center(
                                    child: kIsWeb
                                        ? Image.network(currentItem.image!.path,
                                            fit:
                                                BoxFit.contain) // For Flutter Web
